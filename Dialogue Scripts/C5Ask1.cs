...
public class C5Ask1 : MonoBehaviour
{   
    private CapsuleCollider2D capsuleCollider2D;
    private string reply = "c5Ask1_reply";
    ...
    {
        //KeyItem
        if (GameManager.instance.keysCollected.TryGetValue("c5Book1", out isCollected))
        {
            if (isCollected)
            {
                ((Ink.Runtime.BoolValue)DialogueManager.instance.GetVariableState("c5Ask1_boolAnswer")).value = true;
            }
        }
