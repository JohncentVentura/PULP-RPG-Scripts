...
public class C5Ask4 : MonoBehaviour
{
    private CapsuleCollider2D capsuleCollider2D;
    private string reply = "c5Ask4_reply";
    ...
    {
        //KeyItem
        if (GameManager.instance.keysCollected.TryGetValue("c5Book4", out isCollected))
        {
            if (isCollected)
            {
                ((Ink.Runtime.BoolValue)DialogueManager.instance.GetVariableState("c5Ask4_boolAnswer")).value = true;
            }
        }
