...
public class C5Ask3 : MonoBehaviour
{
    private CapsuleCollider2D capsuleCollider2D;
    private string reply = "c5Ask3_reply";
    ...
    {
        //KeyItem
        if (GameManager.instance.keysCollected.TryGetValue("c5Book3", out isCollected))
        {
            if (isCollected)
            {
                ((Ink.Runtime.BoolValue)DialogueManager.instance.GetVariableState("c5Ask3_boolAnswer")).value = true;
            }
        }
